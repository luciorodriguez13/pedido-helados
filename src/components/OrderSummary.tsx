...
const OrderSummary: React.FC = () => {
  const { customer, containerSize, selectedFlavors, createOrder, resetOrder, setCurrentStep } = useOrder();
  ...
  const handleSubmitOrder = () => {
    ...
    const deliveryInfo = customer.deliveryType === 'delivery' 
      ...
      {!isOrderPlaced ? (
        <>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-pink-50 p-4 rounded-md border border-pink-200">
              ...
              <p className="text-2xl font-bold text-pink-600">${order.price.toLocaleString()}</p>
              {customer.deliveryType === 'delivery' && (
        ...
        <div className="text-center py-8">
          ...
          <p className="text-gray-600 mb-6">
            Tu pedido ha sido enviado por WhatsApp. Pronto te contactaremos para confirmar los detalles.
          </p>
          <button
